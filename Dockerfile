...
CMD mpiexec --allow-run-as-root -n 2 python cm_train.py --training_mode consistency_training --target_ema_mode adaptive --start_ema 0.95 \
...
--save_interval 20000 --wandb True --wandb_project consistency-models-256 --wandb_experiment_name CM_lsun_bedroom_256_batch_8_wavelets_dist_l1_norm_hh_1e-5 \
--ckpts_dir /opt/consistency_models/ckpts/256_dist_l1_norm_hh_1e-5
...
#--sampler onestep --model_path /opt/consistency_models/ckpts/256_dist_target_comp_hh_0.1_hl_0.1_lh_0.1_ll_0.1/target_model080000.pt --attention_resolutions 32,16,8 --class_cond False \
...
#/opt/consistency_models/samples/256_wavelets_hh_0.1_hl_0.1_lh_0.1_ll_0.1_ckpt_80k_onestep/samples_50000x256x256x3.npz
