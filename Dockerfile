...
--save_interval 20000 --wandb True --wandb_project consistency-models --wandb_experiment_name CM_lsun_bedroom_64_batch_64_lr_5e-5_wavelets_hh_10 \
--ckpts_dir /opt/consistency_models/ckpts/64_dist_target_comp_hh_10
